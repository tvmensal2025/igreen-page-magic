...
rootElement.innerHTML = `
  <div style="
    ...
    padding: 20px;
  ">
    <h1 style="font-size: 2.5rem; margin-bottom: 1rem;">ESTA FUNCIONAL? OS 2 ? POSSO INICIAR AS VENDAS?</h1>
    <p style="font-size: 1.2rem; opacity: 0.9;">Auditoria Técnica e Funcional Concluída.</p>
  </div>
`;
