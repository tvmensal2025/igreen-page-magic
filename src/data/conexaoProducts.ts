...
export const conexaoProducts: ConexaoProduct[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        images: [
          "imagem-3-cinemark.webp",
          "imagem-4-pague-menos.webp",
          "imagem-5-dominos-pizza.webp",
          "imagem-6-vivara.webp",
          "imagem-7-casas-bahia.webp",
          "imagem-8-burguer-king.webp",
          "imagem-9-drogasil.webp",
        ],
      },
      {
        type: "advantages",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    heroSubtitle: "Torne-se um Licenciado iGreen Energy e receba comissões sobre 8 produtos diferentes, formando uma equipe e construindo renda passiva",
    heroVideoId: "9b67408c-8b26-4b3e-834b-c02908f21324",
    heroAutoplay: true,
    gradient: "linear-gradient(rgb(14, 128, 40) 0%, rgb(8, 28, 3) 100%)",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "🎯 8 produtos para oferecer: Energia, Telecom, Seguros, Club e mais",
      ...
      },
      {
        ...
        items: [
          ...
          "🎯 8 produtos diferentes para oferecer",
