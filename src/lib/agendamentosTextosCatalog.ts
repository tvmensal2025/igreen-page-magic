...
export const TEXTOS_CATALOGO: TextoCatalogItem[] = [
  ...
  // ── Externos (não dá pra listar tudo inline, mas o botão leva) ──
  {
    ...
    oQueFaz: "Cada passo do Fluxo A/B/C/D tem texto próprio no editor de fluxos.",
    fonte: "externo",
    externoHint: "Admin → Fluxos → selecione o fluxo → edite o passo",
    prioridade: "alta",
  },
  {
    id: "ext_faq",
    grupo: "fluxos",
    nome: "FAQ / atalhos do fluxo (bot_flow_qa)",
    oQueFaz: "Respostas prontas de dúvidas e objeções do fluxo.",
    fonte: "externo",
    externoHint: "Admin → Fluxos → seção FAQ do fluxo",
    prioridade: "media",
  },
  {
    id: "ext_voz",
    ...
    oQueFaz: "Texto da ligação e SMS se não atender (por campanha).",
    fonte: "externo",
    externoHint: "Admin → aba Voz → campanha → TTS / SMS pós-NA",
    toggle: "call_outcome_sms_branch",
    prioridade: "media",
  },
  {
    id: "ext_voice_templates",
    grupo: "voz",
    nome: "Biblioteca de áudios (voice templates)",
    oQueFaz: "Áudios montados para ligações e etapas.",
    fonte: "externo",
    externoHint: "Admin → aba Voz → templates de áudio",
    prioridade: "baixa",
  },
  {
    ...
    oQueFaz: "Templates manuais do WhatsApp (message_templates).",
    fonte: "externo",
    externoHint: "Chat → gerenciador de templates / respostas rápidas",
    prioridade: "baixa",
  },
  {
    id: "ext_bulk",
    grupo: "manual",
    nome: "Campanhas em massa (texto por campanha)",
    oQueFaz: "Cada Disparo PRO tem seu próprio message_text.",
    fonte: "externo",
    externoHint: "Agendamentos → aba Campanhas (ou Disparo PRO)",
  ...
  },
  {
    id: "ext_agenda",
    grupo: "manual",
    nome: "Agenda manual (texto por agendamento)",
    oQueFaz: "Cada mensagem agendada tem texto próprio na hora de criar.",
    fonte: "externo",
    externoHint: "Agendamentos → aba Agenda",
