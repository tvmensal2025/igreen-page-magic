/**
 * Validador da ficha iGreen Club (PF) — independente do Portal 2.
 * NÃO reutilizar validateForPortal (exige energia/docs/OTP).
 *
 * Espelho: supabase/functions/_shared/clubValidation.ts
 */
...
/** Campos canônicos PF Club — ordem visual da ficha. */
...
/** Converte nascimento do CRM → `dd/mm/aaaa` exigido pela API Club. */
