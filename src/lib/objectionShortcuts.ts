...
export const OBJECTION_SHORTCUTS: ObjectionShortcut[] = [
  ...
  // Um card só: mesma resposta FAQ_PADRAO.confianca + todos os gatilhos.
  {
    ...
    triggers: [
      ...
      "suspeito de vocês",
      "nunca ouvi falar",
      "não conheço a igreen",
      "nao conheco a igreen",
  ...
  // ── Cadastro ───────────────────────────────────────────────────────────
  {
    ...
    triggers: [
      "não vou mandar documento",
      "não mando rg",
      "não mando cnh",
      "não envio identidade",
      "não mando doc",
      "não vou mandar foto",
      "não mando foto da conta",
      "privacidade da conta",
      "não envio a conta",
      "por que precisa do cpf",
      "por que pedem cpf",
      "dados pessoais meus",
      "privacidade dos dados",
      "vão vazar meus dados",
      "medo de vazar dados",
      "segurança dos dados",
      "dados protegidos",
      "proteção lgpd",
