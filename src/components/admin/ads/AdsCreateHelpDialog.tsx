        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="rounded-xl border border-[hsl(var(--ads-emerald)/.35)] bg-[hsl(var(--ads-emerald)/.08)] p-3.5 space-y-2">
            ...
            <ul className="space-y-1.5 text-[12px] text-[hsl(var(--ads-text))]">
              ...
              <li className="flex gap-2"><Check className="h-3.5 w-3.5 text-primary shrink-0 mt-0.5" /> O sistema sobe ~15% se o contato estiver barato, desce ~15% se estiver caro</li>
          ...
          <div className="rounded-xl border border-[hsl(var(--ads-border))] bg-secondary/20 p-3.5 space-y-2">
            ...
            <p className="text-[12px] text-[hsl(var(--ads-text))] leading-relaxed">
              ...
              textos, dias, foto/vídeo, se quer remarcar quem já viu, etc.
            </p>
            <ul className="space-y-1.5 text-[12px] text-[hsl(var(--ads-muted))]">
              ...
              <li className="flex gap-2"><Check className="h-3.5 w-3.5 shrink-0 mt-0.5" /> O ajuste automático de orçamento <strong>não</strong> liga sozinho nesta campanha</li>
            </ul>
            {onOpenWizard && (
