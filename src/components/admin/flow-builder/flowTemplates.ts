    ...
    steps: [
      ...
      },
      {
        ...
        captures: [
          {
            ...
            value: [
              ...
              { id: "activate", title: "Ativar benefício" },
              { id: "duvida", title: "Tenho dúvida" },
            ],
          },
        ],
        transitions: [
          ...
          {
            trigger_intent: "palavra_chave",
            trigger_phrases: ["activate", "Ativar benefício", "Quero ativar", "2"],
            goto_step_id: null,
          ...
          {
            trigger_intent: "palavra_chave",
            trigger_phrases: ["duvida", "Tenho dúvida", "3"],
            goto_step_id: null,
      ...
      {
        step_key: "a3b_pedir_pergunta",
        step_type: "message",
        title: "3b — Áudio: pode perguntar",
        icon: "sparkle",
        message_text: null,
        slot_key: "a3b_pedir_pergunta",
        media_order: ["audio"],
        summary: "Áudio convida a perguntar; texto do lead → IA → volta ao passo 3.",
        // enabled=true → chain-stop (não avança para o próximo passo por posição)
        captures: [{ field: "_await_question", enabled: true }],
      },
      {
        step_key: "a5b_after_club_buttons",
        step_type: "message",
        title: "4 — Áudio clube + Ativar / Dúvida / Humano",
        icon: "sparkle",
        message_text: "{{nome}}, quer seguir com a ativação do seu benefício?",
        ...
        captures: [
          {
            ...
            enabled: true,
            value: [
              { id: "register", title: "Ativar benefício" },
              { id: "duvida", title: "Tenho dúvida" },
        ...
        transitions: [
          {
            trigger_intent: "palavra_chave",
            trigger_phrases: ["register", "Ativar benefício", "Cadastrar", "1"],
            goto_step_id: null,
            goto_step_key: "a6_ask_bill_photo",
            goto_special: null,
          },
          {
            trigger_intent: "palavra_chave",
            trigger_phrases: ["duvida", "Tenho dúvida", "2"],
            goto_step_id: null,
            goto_step_key: "a3b_pedir_pergunta",
            goto_special: null,
          },
