...
export const HELP_CATALOG: HelpArticle[] = [
  ...
  article(
    ...
    "Fila de conversão: temperatura, filtros e reativação.",
    "/admin?tab=conversao",
    ["conversão", "reativar", "lead parado", "oportunidade", "quente", "frio"],
    [
      "No menu esquerdo, clique em Conversão.",
      "Na aba Fila, clique em Recarregar se a lista estiver desatualizada.",
      "Filtre por Temperatura (Quente, Morno, Frio, Morto, Objeção, Resgate) e por Origem (Meta Ads, WhatsApp, Parceiro).",
      "Use Buscar nome / resumo para achar um caso específico.",
      "Abra o card, leia o resumo e a próxima ação sugerida.",
      "Para vários de uma vez: marque com Selecionar → Todos (ou alguns) → clique em Reativar.",
      "Confira também as abas Frases, Resultados e Ajustes se precisar mudar textos ou ver desempenho.",
    ],
    13,
  ),
  article(
    ...
    "WhatsApp e IA",
    "Conecte o WhatsApp",
    "Passo a passo do QR Code até o status conectado (Whapi).",
    "/admin?tab=whatsapp",
    ["qr code", "conectar", "instância", "número", "desconectado", "whapi"],
    [
      ...
      "Se travar: use Resetar Conexão (com cuidado) e depois Conectar WhatsApp novamente. Não peça “reconectar Evolution” — o canal em uso é este WhatsApp da plataforma.",
    ],
    20,
    true,
  ),
  ...
  article(
    ...
    [
      ...
      "Para criar: clique em Criar campanha (abre o assistente de publicação).",
      ...
      "Clique em Sincronizar agora para atualizar métricas; use Ver último sync se algo parecer atrasado.",
  ...
  article(
    ...
    [
      "Abra Meta Ads em /admin/meta-ads, ou no menu clique em Central de anúncios → Criar campanha.",
  ...
  article(
    ...
    [
      ...
      "Use as abas: Mapa | Grupo A | Grupo B | Grupo C | Agenda | Carteira | Histórico.",
  ...
  article(
    ...
    "Ligar o motor, horários e tick — preferir pela aba Grupo B.",
    "/admin/motor",
    ["cadência", "follow-up", "ligação", "sms", "sem resposta", "grupo b"],
    [
      "Caminho recomendado: no menu clique em Agendamentos → aba Grupo B (leads frios). Atalho técnico: /admin/motor.",
  ...
  article(
    ...
    [
      "Abra /admin/reaquecimento ou Agendamentos → Agenda → Reaquecimento / atalho Grupo B — Reaquecimento.",
