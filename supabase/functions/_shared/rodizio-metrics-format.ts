  ...
  switch (reason) {
    ...
    case "auto_performance":
      return [
        ...
        `🎯 *${name}*`,
        ``,
        `O Cérebro pausou esta praça porque o`,
        `*custo não estava compensando* nas últimas`,
        `horas (pouca conversa / gasto alto).`,
        ``,
        `Estamos *protegendo o investimento* e`,
        `abrindo espaço para praças com sinal melhor.`,
        ``,
        `Faz parte da rotina — quando a performance`,
        `voltar, a equipe reativa com carinho. 🔥`,
        ...footer,
      ].join("\n");
    default:
      return [
