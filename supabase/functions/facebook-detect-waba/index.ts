      ...
      try {
        ...
        if (isWabaMismatch) {
          return jsonRes({
            ...
            auto_filled: true,
            needs_pick: false,
            hint: `A Meta encontrou o número ${waba.chosen.display}, mas ele ainda não está vinculado à Página usada nos anúncios. Vá em Central de anúncios → WhatsApp dos anúncios (CTWA) e vincule a WABA à Página se continuar recusando.`,
            meta_message: msg,
            next_steps: [
              `Vincule a WABA ${waba.waba_id || "do número"} à Página ${waba.page_id || "da plataforma"}`,
              "Confirme o número em Central de anúncios → WhatsApp dos anúncios (CTWA)",
              "Publique de novo após o vínculo Página ↔ WABA",
            ],
