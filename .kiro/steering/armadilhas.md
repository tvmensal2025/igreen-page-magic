...
49. **Conectar Evolution = logout+delete+nome fresco** → **PROIBIDO** (ban sem spam; Abel 2026-07-28). Correto: `getFixedInstanceName` + `create` só se `missing` + `connect` na mesma; logout/delete só em Reset/trocar chip. UI: “Reconectar (mesma sessão)”, cooldown QR 30s, Reset = último recurso.
